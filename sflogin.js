...
var Promise, SFLogin, basedir, color, crypto, error, fs, iprompt, jsforce, keytar, path, q;
...
SFLogin = (function() {
  ...
  SFLogin.prototype.chooseLogin = function(options, cb) {
  ...
  SFLogin.prototype.manualLogin = function(options, cb) {
    this.activeLogin = {
    ...
    return this.login(options, true, cb);
  };

  SFLogin.prototype.login = function(options, reinit, cb) {
