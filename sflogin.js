...
var SFLogin, basedir, color, fs, iprompt, jsforce, keytar, path, q;
    ...
    return iprompt(questions, (function(_this) {
      return function(params) {
        ...
        return fs.readFile(_this.passFile, "utf8", function(er, data) {
          ...
          if (keytar.getPassword('SPM-SFDC: ' + _this.params.loginUrl, _this.params.username) === null) {
          ...
          _this.activeLogin = {
            ...
            loginUrl: _this.params.loginUrl,
            apiVersion: _this.params.apiVersion,
            password: keytar.getPassword('SPM-SFDC: ' + _this.params.loginUrl, _this.params.username)
          };
